...
let current_users :string []= ["khan","Imad","mazhar","Bilal","Naeem"]
// console.log("Task 2:")
 
let new_users:string [] =["Shahab","Jabbar","mazhar","khan","Muhammad"]
...
}else {console.log(`Yes ${new_user} this name is available.`)}
}